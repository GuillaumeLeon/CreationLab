...
<div class="row post mt-3 mb-3 shadow">
    <div class="corps">
        ...
        <div class="interaction">
          <div class="row">
            <div class="col-1 icon-bar ml-3"><a href="connection.php"><i class="fas fa-comments ml-3" data-toggle="tooltip" data-placement="top" title="Commentez" style="font-size:30px"></i> </a></div>
            <div class="col-1 icon-bar "><a href="#"><i class="fas fa-share ml-3" data-toggle="tooltip" data-placement="top" title="Partager" style="font-size:30px"></i></a></div>
            <div class="col-1 icon-bar "><button id="<?= $value['post_id']?>" class="bg-transparent" onclick="favoris(this.id)"><i class="far fa-bookmark" data-toggle="tooltip" data-placement="top" title="Enregistrer" style="font-size:30px"></i></button></div>
            <div class="col-1 icon-bar "><a href="connection.php"><i class="fas fa-sign-in-alt ml-3" data-toggle="tooltip" data-placement="top" title="Continuer l'histoire" style="font-size:30px"></i></a></div>
        </div>
      </div>
    </div>
</div>
